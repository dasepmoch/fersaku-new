...
| `[x]` | `PUB-210` | P1 | PUB-100 | PUB | completed @nikki/opencode · main · 2026-07-17 18:40 WIB · claim released | Store search and safe social links | TASK/evidence/PUB-210/20260717-1840-nikki.md · features/catalog · app/store · tests/unit/pub-210-storefront-search-socials.test.ts |
| `[x]` | `PUB-220` | P1/P2 | INT-180 **if live status dependency**, QLT-320 framework; `public-catalog` QLT-320 cell before canary | PUB/RTM | completed @nikki/opencode · main · 2026-07-17 18:45 WIB · claim released | Truthful public platform status (informational disposition) | TASK/evidence/PUB-220/20260717-1845-nikki.md · features/platform-status · app/(resources)/status/page.tsx · tests/unit/pub-220-public-status.test.ts |
| `[x]` | `PUB-230` | P1 decision | INT-025, UI-080 | PUB/UX | completed @nikki/opencode · main · 2026-07-17 18:43 WIB · claim released | Static/help/careers/playground disposition | TASK/evidence/PUB-230/20260717-1843-nikki.md · tests/unit/pub-230-static-disposition.test.ts · architecture-boundaries.test.ts |
...
| `[x]` | `SEL-230` | P1 | SEL-100; INT-180/185 **if scan lifecycle active** | SEL/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Store/public asset safe upload/scan | TASK/evidence/SEL-230/20260717-sel230-nikki.md · features/seller/objects · tests/unit/sel-230-store-object-upload.test.ts |
| `[x]` | `SEL-240` | P0/P1 | SEL-220, INT-140 | SEL | completed @nikki/opencode · main · 2026-07-17 · claim released | Inventory schema/import/reveal/revoke | TASK/evidence/SEL-240/20260717-sel240-nikki.md · features/seller/inventory · tests/unit/sel-240-seller-inventory.test.ts |
...
| `[x]` | `SEL-310` | P1/P2 | SEL-100, SEL-230; INT-180 **if custom-domain/provider active** | SEL/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Store settings/domain/SEO | TASK/evidence/SEL-310/20260717-sel310-nikki.md · features/seller/store-domains · tests/unit/sel-310-seller-store-domains.test.ts |
| `[x]` | `SEL-320` | P1 | SEL-100; INT-180/185 **if webhook delivery active** | SEL/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Seller outbound webhooks/secret claims | TASK/evidence/SEL-320/20260717-sel320-nikki.md · features/seller/webhooks · tests/unit/sel-320-seller-webhooks.test.ts |
| `[x]` | `SEL-330` | P1 | SEL-100, INT-140; INT-180/185 **if credential/KYC runtime active** | SEL/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | API credentials + seller KYC capability | TASK/evidence/SEL-330/20260717-sel330-nikki.md · features/seller/api-credentials · tests/unit/sel-330-seller-api-credentials.test.ts |
...
| `[x]` | `SEL-410` | P0 money | SEL-340, SEL-400, INT-140, INT-180, INT-185 | SEL/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Secure withdrawal lifecycle | TASK/evidence/SEL-410/20260717-1807-nikki.md · features/finance · features/seller/screens/finance · tests/unit/sel-410-seller-withdrawal.test.ts |
...
| `[x]` | `ADM-210` | P1 | ADM-110, ADM-120, BUY-100 | ADM | completed @nikki/opencode · main · 2026-07-17 · claim released | Buyer support surface | TASK/evidence/ADM-210/20260717-adm210-nikki.md · features/admin/data/buyers.ts · buyers screens · tests/unit/adm-210-admin-buyers.test.ts |
| `[x]` | `ADM-220` | P0/P1 | ADM-100, ADM-110, AUT-120 | ADM | completed @nikki/opencode · main · 2026-07-17 · claim released | Staff/invite/role/permission lifecycle | TASK/evidence/ADM-220/20260717-adm220-nikki.md · features/admin/data/access.ts · screens/access · tests/unit/adm-220-admin-access.test.ts |
| `[x]` | `ADM-230` | P1 | ADM-100, ADM-110, AUT-120, BUY-140; INT-175 if photo active | ADM | completed @nikki/opencode · main · 2026-07-17 · claim released | Admin profile/sessions/notifications | TASK/evidence/ADM-230/20260717-1716-nikki.md · features/admin/profile · profile screen · admin-shell · tests/unit/adm-230-admin-profile.test.ts |
| `[x]` | `ADM-300` | P0/P1 | ADM-110, ADM-120, CHK-130; INT-180 **if provider evidence/command active** | ADM/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Order/payment evidence/commands | TASK/evidence/ADM-300/20260717-adm300-nikki.md · features/admin/data/orders.ts · payments.ts · order-payment-commands.ts · screens/orders.tsx · payments.tsx · tests/unit/adm-300-admin-orders-payments.test.ts |
| `[x]` | `ADM-310` | P0 money | ADM-110, SEL-410; INT-180/185 **if disbursement active** | ADM/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Withdrawal review/disbursement | TASK/evidence/ADM-310/20260717-adm310-nikki.md · features/admin/data/withdrawal-commands.ts · withdrawals.ts · screens/withdrawals.tsx · tests/unit/adm-310-admin-withdrawals.test.ts |
| `[x]` | `ADM-320` | P0 secret | ADM-110, SEL-240, SEL-250, INT-140 | ADM | completed @nikki/opencode · main · 2026-07-17 · claim released | Redacted inventory/reveal/fulfillment | TASK/evidence/ADM-320/20260717-1728-nikki.md · features/admin/data/inventory.ts · fulfillments.ts · fulfillment-commands.ts · screens · tests/unit/adm-320-admin-inventory-fulfillment.test.ts |
| `[x]` | `ADM-330` | P1 | ADM-110, SEL-270 | ADM | completed @nikki/opencode · main · 2026-07-17 · claim released | Review moderation | TASK/evidence/ADM-330/20260717-adm330-nikki.md · features/admin/data/reviews.ts · review-commands.ts · screens/reviews.tsx · tests/unit/adm-330-admin-reviews.test.ts |
| `[x]` | `ADM-340` | P0 PII | ADM-110, INT-140; INT-180/185 **if KYC runtime active**; co-evolve SEL-330 | ADM/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | KYC review + server-decrypted content | TASK/evidence/ADM-340/20260717-adm340-nikki.md · features/admin/operations/kyc · tests/unit/adm-340-admin-kyc.test.ts |
| `[x]` | `ADM-350` | P0/P1 | ADM-110, SEL-320; INT-180/185 **if callback/delivery runtime active** | ADM/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Callback and seller-delivery operations | TASK/evidence/ADM-350/20260717-adm350-nikki.md · features/admin/operations/webhooks · tests/unit/adm-350-admin-webhooks.test.ts |
...
| `[x]` | `ADM-370` | P0 live | ADM-110; INT-180/185 **if runtime controls active**; QLT-320 framework; `admin-runtime-audit` QLT-320 cell before canary | ADM/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Truthful provider/system/emergency controls | TASK/evidence/ADM-370/20260717-adm370-nikki.md · features/admin/operations/emergency · domains/providers · screens/system.tsx · commerce/fee-policy-preview.tsx · tests/unit/adm-370-admin-providers-system.test.ts |
| `[x]` | `ADM-380` | P1/P2 decision | ADM-110, INT-025, UI-080 | ADM/UX | completed @nikki/opencode · main · 2026-07-17 · claim released | Campaign live-disabled (launch OUT-OF-SCOPE) | TASK/evidence/ADM-380/20260717-adm380-nikki.md · features/admin/commerce/campaigns · tests/unit/adm-380-campaigns-disposition.test.ts |
...
| `[x]` | `QLT-200` | P0/P1 continuous | INT-000, INT-010; domain task co-evolves | QA/domain | completed @nikki/opencode · main · 2026-07-17 · claim released | Unit/mapper/provider-consumer contract harness (parent) | TASK/evidence/QLT-200/20260717-qlt200-nikki.md · vitest.config.ts · tests/contract/** · backend/test/contract/provider_presenter_test.go · docs/QLT-200-CONTRACT-COEVOLUTION.md |
| `[x]` | `QLT-210` | P0 continuous | QLT-100; tested migration/domain co-evolves | QA/domain | completed @nikki/opencode · main · 2026-07-17 · claim released | Real DB/concurrency/integration suite (parent) | TASK/evidence/QLT-210/20260717-qlt210-nikki.md · docs/QLT-210-INTEGRATION-COEVOLUTION.md · backend/test/integration/foundation_test.go · backend/Makefile · scripts/ci-assert-suite.mjs · .github/workflows/backend-ci.yml |
...
| `[x]` | `QLT-220` | P0 continuous | QLT-215, INT-190; co-evolve with active domain implementation | QA/domain | completed @nikki/opencode · main · 2026-07-17 · claim released | Cross-stack API E2E harness (parent) | TASK/evidence/QLT-220/20260717-1903-nikki.md · docs/QLT-220-API-E2E-COEVOLUTION.md · tests/e2e/api/qlt-220-parent-framework.spec.ts · tests/e2e/api/helpers/auth.ts · scripts/ci-assert-suite.mjs · .github/workflows/ci.yml |
| `[x]` | `QLT-230` | P0 UI continuous | UI-000, UI-050, UI-060, QLT-100; API parity also QLT-110/215/domain | QA/UX | completed @nikki/opencode · main · 2026-07-17 · claim released | Visual/responsive/a11y/interaction harness (parent) | TASK/evidence/QLT-230/20260717-qlt230-nikki.md · docs/QLT-230-VISUAL-A11Y-COEVOLUTION.md · tests/e2e/qlt-230-parent-framework.spec.ts · scripts/ci-assert-suite.mjs · .github/workflows/ci.yml |
| `[x]` | `QLT-300` | P0 continuous | INT-120, INT-130, INT-140, INT-150, INT-170; INT-180 **if live provider/security integration**; capability cells co-evolve | QA/security | completed @nikki/opencode · main · 2026-07-17 · claim released | Security/privacy matrix harness (parent) | TASK/evidence/QLT-300/20260717-qlt300-nikki.md · docs/QLT-300-SECURITY-COEVOLUTION.md · tests/unit/qlt-300-parent-framework.test.ts · scripts/ci-assert-suite.mjs · .github/workflows/ci.yml |
| `[x]` | `QLT-310` | P1 continuous | INT-160; capability cells co-evolve | QA/domain | completed @nikki/opencode · main · 2026-07-17 · claim released | Smoothness/performance budget harness (parent) | TASK/evidence/QLT-310/20260717-qlt310-nikki.md · docs/QLT-310-PERFORMANCE-COEVOLUTION.md · tests/unit/qlt-310-parent-framework.test.ts · scripts/ci-assert-suite.mjs · .github/workflows/ci.yml |
| `[x]` | `QLT-320` | P0 live continuous | INT-170; INT-180/185 **if live signals/runtime active**; capability cells co-evolve | QA/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Observability/alerts/dashboard/runbooks harness (parent) | TASK/evidence/QLT-320/20260717-qlt320-nikki.md · docs/QLT-320-OBSERVABILITY-COEVOLUTION.md · tests/unit/qlt-320-parent-framework.test.ts · scripts/ci-assert-suite.mjs · .github/workflows/ci.yml |
| `[x]` | `QLT-400` | P0 continuous | INT-025, INT-170, QLT-320 framework; selected capability cells are activation gates | QA/FND | completed @nikki/opencode · main · 2026-07-17 · claim released | Independent flags/canary/kill switch harness (parent) | TASK/evidence/QLT-400/20260717-qlt400-nikki.md · docs/QLT-400-FLAGS-COEVOLUTION.md · shared/data/domain-flags.ts · tests/unit/qlt-400-parent-framework.test.ts · scripts/ci-assert-suite.mjs · .github/workflows/ci.yml |
| `[x]` | `QLT-410` | P0 continuous | INT-000; INT-180 **if live migration/runtime dependency**; QLT-210 framework; changed migration/domain gets a matching cell | QA/RTM | completed @nikki/opencode · main · 2026-07-17 · claim released | Expand-contract deploy/rollback harness (parent) | TASK/evidence/QLT-410/20260717-qlt410-nikki.md · docs/QLT-410-DEPLOY-ROLLBACK-COEVOLUTION.md · tests/unit/qlt-410-parent-framework.test.ts · scripts/ci-assert-suite.mjs · .github/workflows/ci.yml |
| `[x]` | `QLT-420` | P1 continuous | QLT-105 framework plus selected QLT-105/220/230/300/310/320/400/410 cells for every launch domain (activation gates; parent harness only) | QA | completed @nikki/opencode · main · 2026-07-17 · claim released | Safe cutover + post-cutover mock cleanup harness (parent) | TASK/evidence/QLT-420/20260717-qlt420-nikki.md · docs/QLT-420-CUTOVER-COEVOLUTION.md · tests/unit/qlt-420-parent-framework.test.ts · scripts/ci-assert-suite.mjs · .github/workflows/ci.yml |
